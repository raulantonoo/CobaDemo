            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                ...
                <ul class="navbar-nav ml-auto mr-0">
                    ...
                    <li class="nav-item mr-5">
                        ...
                        <a class="nav-link" style="color:white; font-size:23px;" href="/cart"><img src="{{ asset('../images/cart.png') }}" width="50px" style="margin-top:-15px!important;margin-bottom:-15px;margin-right:-5px;margin-left:10px"> 
